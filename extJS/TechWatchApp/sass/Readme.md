...
folder are mapped to the application's root namespace, 'TechWatchExtApp'. This is set in
`"app.json"`:

    "sass": {
        "namespace": "TechWatchExtApp"
    }
...
included in the application's JavaScript code build. By default, files in this 
folder are mapped to the application's root namespace, 'TechWatchExtApp' in the same way
as `"TechWatchExtApp/sass/src"`.
